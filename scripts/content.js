...
const elementIncluded = (element) =>
  analyse.includes(element.manFullName) && analyse.includes(...element.tags);

const matchingMan = correspondance.find(elementIncluded);
if (matchingMan) showLogo(matchingMan);
